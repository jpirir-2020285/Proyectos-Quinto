...
Create table CargoEmpleado(
    ...
    descipcionCargo varchar(45) not null,
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarProveedores (in NITProveedor varchar(10), in nombresProveedor varchar(60), 
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarCompras (in numeroDocumento int, in fechaDocumento date, 
...
-- Buscar
Delimiter $$
	Create procedure sp_BuscarCompras (in numDocumento int)
    Begin
		Select
			C.numeroDocumento, 
            C.fechaDocumento, 
...
-- Editar
Delimiter $$
	Create procedure sp_EditarCompras (in numDocumento int, in fechDocumento date, 
...
-- Eliminar
Delimiter $$
	Create procedure sp_EliminarCompras (in numDocumento int)
    Begin
		Delete from  Compras
			Where numeroDocumento = numDocumento;
    End$$
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarClientes (in NITCliente varchar(10), 
    ...
    Begin
		Insert into Cliente (NITCliente, nombresCliente, apellidosCliente, direccionCliente, telefonoCliente, correoCliente)
...
-- Editar
Delimiter $$
	Create procedure sp_EditarClientes (in codCliente int, in NIT varchar(10), 
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarCargoEmpleado (in nombreCargo varchar(45), in descipcionCargo varchar(45))
    Begin
		Insert into CargoEmpleado (nombreCargo, descipcionCargo)
			values (nombreCargo, descipcionCargo);
    End$$
Delimiter ;
...
Delimiter $$
	Create procedure sp_EditarCargoEmpleado (in codCargoEmpleado int, 
		in nomCargo varchar(45), in descipCargo varchar(45))
    Begin
		Update CargoEmpleado CE
			Set 
				CE.nombreCargo = nomCargo, 
				CE.descipcionCargo = descipCargo
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarDetalleCompra (in codigoDetalleCompra int, in costoUnitario decimal(10,2), 
...
-- Agregar
Delimiter $$
	Create procedure sp_AgregarEmpleados (in codigoEmpleado int, in nombresEmpleado varchar(50), 
